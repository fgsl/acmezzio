...
return [
    'dependencies' => [
        'factories' => [
            Equipment\Handler\EquipmentHandler::class => Equipment\Handler\EquipmentHandlerFactory::class,
            Equipment\Handler\IndexHandler::class => Equipment\Handler\IndexHandlerFactory::class,
        ],
    ],
];
